...
You can find the IoT Cloud Twins documentation at the following link: [IoT Hub Cloud Twins](/iot/iot-hub/reference-content/twins/)

## Internet Alarm Control Panel

Let’s use this minimalistic example: you have an internet-enabled alarm control panel with a door sensor and a siren. Here are a few things to handle properly:
